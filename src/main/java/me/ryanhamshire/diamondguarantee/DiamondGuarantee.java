...
public class DiamondGuarantee extends JavaPlugin {
    ...
    private void loadConfig() {
        ...
        defaultSettings.deepslateValueOutsideZone = config.getLong("Diamond Generation.Deepslate Value.Outside Diamond Zone", 1);
        defaultSettings.deepslateValueInsideZone = config.getLong("Diamond Generation.Deepslate Value.Outside Diamond Zone", 4);
        ...
        for(World world : this.getServer().getWorlds()) {
            ...
            settings.diamondZoneMinY =
                    config.getInt(world.getName() + ".Diamond Zone.Minimum Y Value", defaultSettings.diamondZoneMinY);
            settings.diamondZoneMaxY =
                    config.getInt(world.getName() + ".Diamond Zone.Maximum Y Value", defaultSettings.diamondZoneMaxY);
            settings.generateDiamonds =
                    config.getBoolean(world.getName() + ".Diamond Generation.Enabled", defaultSettings.generateDiamonds);
            settings.diamondValue =
                    config.getLong(world.getName() + ".Diamond Generation.Diamond Value", defaultSettings.diamondValue);
            settings.stoneValueOutsideZone =
                    config.getLong(world.getName() + ".Diamond Generation.Stone Value.Outside Diamond Zone", defaultSettings.stoneValueOutsideZone);
            settings.stoneValueInsideZone =
                    config.getLong(world.getName() + ".Diamond Generation.Stone Value.Inside Diamond Zone", defaultSettings.stoneValueInsideZone);
            settings.deepslateValueOutsideZone =
                    config.getLong(world.getName() + ".Diamond Generation.Deepslate Value.Outside Diamond Zone", defaultSettings.deepslateValueOutsideZone);
            settings.deepslateValueInsideZone =
                    config.getLong(world.getName() + ".Diamond Generation.Deepslate Value.Inside Diamond Zone", defaultSettings.deepslateValueInsideZone);
            settings.generateDiamondsLog =
                    config.getBoolean(world.getName() + ".Diamond Generation.Log Details", defaultSettings.generateDiamondsLog);
            settings.ghastDustCount =
                    config.getInt(world.getName() + ".Ghasts Drop This Many Glowstone Dust", defaultSettings.ghastDustCount);
            settings.dragonDropsEggs =
            ...
            if (world.getEnvironment() == Environment.NORMAL) {
                ...
                outConfig.set(world.getName() + ".Diamond Generation.Deepslate Value.Outside Diamond Zone", settings.deepslateValueOutsideZone);
                outConfig.set(world.getName() + ".Diamond Generation.Deepslate Value.Inside Diamond Zone", settings.deepslateValueInsideZone);
        ...
        outConfig.set("Diamond Generation.Deepslate Value.Outside Diamond Zone", defaultSettings.deepslateValueOutsideZone);
        outConfig.set("Diamond Generation.Deepslate Value.Inside Diamond Zone", defaultSettings.deepslateValueInsideZone);
